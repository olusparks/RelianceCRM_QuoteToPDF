<%@ Page Language="VB" AutoEventWireup="false" EnableEventValidation="false" CodeFile="DynamicSend.aspx.vb" Inherits="DynamicSend" %>
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="style1" style="border: 1px solid #BCB0B0">
                                            <tr>
                                                <td style="padding-left: 2px; width: 400px; height: 30px;">
                                                    <asp:Button ID="btnSend" runat="server" CssClass="btnemail ibtn" Text="Send" />
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblmsg" runat="server" BackColor="#F1F1F1"
                                            BorderStyle="None" Font-Bold="True" Font-Size="13px" ForeColor="Red"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table class="style1">
                                            ...
                                            <tr>
                                                <td class="style3"> <asp:Button ID="btnGetContact" runat="server" Text="Cc" SkinID="Normal" /></td>
                                                <td>
                                                    <table>
                                                        <tr>
                                                           <%-- <td style="width: 80px">
                                                                                ...
                                                                                <td>
                                                                                    <div style="font-size: small" class="iround">
                                                                                        <div style="margin: 0px; padding: 1px 1px 0px 0px; float: left;">
                                                                                            <asp:Literal ID="litName" runat="server" Text='<%# Eval("FullName") %>'></asp:Literal>
                                                                                        </div>

                                                                                        <div style="margin: 0px; padding: 1px 1px 0px 5px; float: left">
                                                                                            <asp:ImageButton ID="btnRemove" runat="server" CommandArgument='<%# Eval("EmailAddress") %>' ImageUrl="~/App_Themes/mydefault/Images/x-icon.png" />
                                                                                        </div>
                                            ...
                                            <tr>
                                                <td class="style3" colspan="2">Quote Attached:<asp:LinkButton ID="hyp" runat="server" BackColor="#F1F1F1"
                                                    Font-Size="Medium" Font-Underline="True" ForeColor="#0099CC" Width="43%"></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <table align="left" width="100%">
                                        <tr>
                                            <td style="border-bottom: 1px groove #C0C0C0; color: #28323E; font-size: 172%; height: 35px">
                                                <asp:Button ID="btnSaveContact" runat="server" CssClass="btnsave ibtn" Text="Save" />
                                                <asp:Button ID="BtnRemoveContact" runat="server" Text="Cancel"
                                                    CssClass="btncancel ibtn" Style="font-weight: normal" Enabled="false" /></td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0" class="style1">
                                                    <tr>
                                                        ...
                                                        <td style="color: #28323E; height: auto; text-align: left">
                                                            <asp:DataList ID="ddlAddress" runat="server" RepeatLayout="Flow" HorizontalAlign="Left" RepeatDirection="Horizontal" AutoPostBack="True">
                                                                <HeaderStyle VerticalAlign="Top" />
                                                                <ItemStyle BorderStyle="None" HorizontalAlign="Left" />
                                                                <ItemTemplate>
                                                                    <table>
                            ...
                            <asp:Panel runat="server" ID="Panel1" class="box">
                                ...
                                <div class="box-content">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" EnableTheming="true" CssClass="defaultGrid"
                                        DataKeyNames="RelatedContactGuid" Width="100%">
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                   <%# DataBinder.Eval(Container.DataItem, "RelatedContactGuid") %> 
                                                </ItemTemplate>
                                            </asp:TemplateField>
